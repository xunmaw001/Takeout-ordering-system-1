...
public class DiscusscantingxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscusscantingxinxiEntity discusscantingxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusscantingxinxiEntity discusscantingxinxi, HttpServletRequest request){
        EntityWrapper<DiscusscantingxinxiEntity> ew = new EntityWrapper<DiscusscantingxinxiEntity>();
		PageUtils page = discusscantingxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusscantingxinxi), params), params));
        return R.ok().put("data", page);
    }
