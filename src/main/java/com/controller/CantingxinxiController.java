...
public class CantingxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CantingxinxiEntity cantingxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CantingxinxiEntity cantingxinxi, HttpServletRequest request){
        EntityWrapper<CantingxinxiEntity> ew = new EntityWrapper<CantingxinxiEntity>();
		PageUtils page = cantingxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, cantingxinxi), params), params));
        return R.ok().put("data", page);
    }
